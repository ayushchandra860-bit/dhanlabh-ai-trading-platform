...
Production-oriented Version 1 PWA for probability-based Olymp Trade style market analysis. It includes a React/Vite/Tailwind frontend, Node/Express backend, WebSocket streaming, modular AI engines, journaling, screenshot analysis, backtesting, PWA install support, and Render deployment config.
...
- OTC assets: represented with the best available free proxy feed plus OTC-style continuity modelling, clearly labelled in the UI.
- Composite indices: Europe, Asia, Crypto, Americas, Balanced, and Compound composites are calculated from underlying proxy components.
